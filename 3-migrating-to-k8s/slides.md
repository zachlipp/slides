...
We want to classify hospital purchases
...
<h2>Output:</h2>
<ul>
<li><strong>Category</strong>: Sutures</li>
<li><strong>Score</strong>: 98/100</li>
</div>
...
The most important feature here is the purchase descriptions. We can map these descriptions to numbers and use those numbers as inputs into machine learning models. This is called *(short) text classification*.
...
1. Jupyter + Excel
2. Models on EC2 + Django app
3. Models on Kubernetes + Django app
